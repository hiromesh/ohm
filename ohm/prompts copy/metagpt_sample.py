...
You can use the functions provided by the public library ohm, but can't use functions from other third-party libraries. The public library is imported as variable x by default.
- `import ohm as x`
