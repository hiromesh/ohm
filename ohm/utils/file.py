...
from ohm.utils import read_docx
from ohm.utils.common import async_read, aread_bin, awrite_bin, check_http_endpoint
from ohm.utils.exceptions import handle_exception
from ohm.utils.repo_to_markdown import is_text_file
...
class File:
    ...
    async def _omniparse_read_file(path: Union[str, Path], auto_save_image: bool = False) -> Optional[str]:
        from ohm.tools.libs import get_env_default
        from ohm.utils.omniparse_client import OmniParseClient
