...
from ohm.utils.common import async_write, check_cmd_exists
...
async def mermaid_to_file(
    ...
    await async_write(filename=tmp, data=mermaid_code)
    ...
    if engine == "nodejs":
        ...
        if engine == "playwright":
            from ohm.utils.mmdc_playwright import mermaid_to_file

            return await mermaid_to_file(mermaid_code, output_file_without_suffix, width, height, suffixes=suffixes)
        elif engine == "pyppeteer":
            from ohm.utils.mmdc_pyppeteer import mermaid_to_file

            return await mermaid_to_file(mermaid_code, output_file_without_suffix, width, height, suffixes=suffixes)
        elif engine == "ink":
            from ohm.utils.mmdc_ink import mermaid_to_file
