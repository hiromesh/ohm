...
from ohm.const import CONFIG_ROOT
...
def startup(
    ...
    init_config: bool = typer.Option(default=False, help="Initialize the configuration file for ohm."),
):
    ...
    if idea is None:
        typer.echo("Missing argument 'IDEA'. Run 'ohm --help' for more information.")
        raise typer.Exit()
...
DEFAULT_CONFIG = """# Full Example: https://github.com/geekan/ohm/blob/main/config/config2.example.yaml
# Reflected Code: https://github.com/geekan/ohm/blob/main/ohm/config2.py
...
def copy_config_to():
    """Initialize the configuration file for ohm."""
