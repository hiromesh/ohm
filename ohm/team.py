...
from ohm.const import SERDESER_PATH
from ohm.context import Context
from ohm.environment import Environment
from ohm.environment.mgx.mgx_env import MGXEnv
...
class Team(BaseModel):
    ...
    def serialize(self, stg_path: Path = None):
        stg_path = SERDESER_PATH.joinpath(
            "team") if stg_path is None else stg_path
