...
from ohm.configs.embedding_config import EmbeddingType
from ohm.logs import logger
from ohm.rag.interface import RAGObject
from ohm.rag.prompts.default_prompts import DEFAULT_CHOICE_SELECT_PROMPT
...
class MilvusRetrieverConfig(IndexRetrieverConfig):
    ...
    collection_name: str = Field(default="ohm", description="The name of the collection.")
...
class ElasticsearchStoreConfig(BaseModel):
    index_name: str = Field(default="ohm", description="Name of the Elasticsearch index.")
