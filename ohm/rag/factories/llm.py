...
class RAGLLM(CustomLLM):
    """LlamaIndex's LLM is different from ohm's LLM.

    Inherit CustomLLM from llamaindex, making ohm's LLM can be used by LlamaIndex.
    ...
    model_infer: BaseLLM = Field(..., description="The ohm's LLM.")
