...
source $REPO_ROOT_DIR/ohm/tools/swe_agent_commands/_setup_default_env.sh

# make _split_string (py) available
export PATH=$PATH:$REPO_ROOT_DIR/ohm/tools/swe_agent_commands

source $REPO_ROOT_DIR/ohm/tools/swe_agent_commands/defaults.sh
source $REPO_ROOT_DIR/ohm/tools/swe_agent_commands/search.sh
source $REPO_ROOT_DIR/ohm/tools/swe_agent_commands/edit_linting.sh
