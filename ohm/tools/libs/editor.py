...
from ohm.const import DEFAULT_MIN_TOKEN_COUNT, DEFAULT_WORKSPACE_ROOT
from ohm.tools.libs.linter import Linter
...
class Editor(BaseModel):
    ...
    async def similarity_search(query: str, path: Union[str, Path]) -> List[str]:
        ...
        """
        try:
            from ohm.tools.libs.index_repo import IndexRepo
