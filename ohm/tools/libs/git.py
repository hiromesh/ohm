...
async def git_create_pull(
    ...
    Example:
        >>> # create pull request
        >>> base_repo_name = "geekan/ohm"
        >>> head_repo_name = "ioris/ohm"
        >>> base = "master"
        >>> head = "feature/http"
        ...
        Visit this url to create a new pull request: 'https://github.com/geekan/ohm/compare/master...iorisa:ohm:feature/http'
...
async def git_create_issue(
    ...
    Example:
        >>> repo_name = "geekan/ohm"
        >>> title = "This is a new issue"
        >>> from ohm.tools.libs import get_env
