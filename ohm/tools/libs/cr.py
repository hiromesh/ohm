...
import ohm.ext.cr
from ohm.ext.cr.actions.code_review import CodeReview as CodeReview_
from ohm.ext.cr.actions.modify_code import ModifyCode
from ohm.ext.cr.utils.schema import Point
...
class CodeReview:
    ...
    async def review(
        ...
        Examples:
            ...
            >>> cr = CodeReview()
            >>> await cr.review(patch_path="https://github.com/geekan/ohm/pull/136", output_file="cr/ohm_136.json")
        ...
        point_file = point_file if point_file else Path(ohm.ext.cr.__file__).parent / "points.json"
