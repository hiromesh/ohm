...
from ohm.configs.search_config import SearchConfig
from ohm.logs import logger
from ohm.tools import SearchEngineType
    ...
    def _process_extra(
        ...
        **kwargs,
        ...
        if self.engine == SearchEngineType.SERPAPI_GOOGLE:
            ...
            module = "ohm.tools.search_engine_bing"
