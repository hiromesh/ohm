...
@Time    : 2023/8/18
@Author  : mashenquan
@File    : ohm_text_to_image.py
@Desc    : ohm Text-to-Image OAS3 api, which provides text-to-image functionality.
"""
import base64
...
# Export
async def oas3_ohm_text_to_image(text, size_type: str = "512x512", model_url=""):
    """Text to image
    ...
    if not text:
        return ""
    return await ohmText2Image(model_url).text_2_image(text, size_type=size_type)
