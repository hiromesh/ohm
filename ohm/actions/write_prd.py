...
from ohm.actions.write_prd_an import (
...
from ohm.schema import AIMessage, Document, Documents, Message
...
from ohm.utils.mermaid import mermaid_to_file
from ohm.utils.project_repo import ProjectRepo
from ohm.utils.report import DocsReporter, GalleryReporter
    ...
    async def _execute_api(
        ...
        async with DocsReporter(enable_llm_stream=True) as reporter:
            ...
            if not legacy_prd_filename:
                ...
                content = await async_read(filename=legacy_prd_filename)
            ...
            await async_write(filename=output_pathname, data=new_prd.content)
