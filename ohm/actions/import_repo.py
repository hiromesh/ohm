...
This script defines an action to import a Git repository into the ohm project format, enabling incremental
 appending of requirements.
The ohm project format encompasses a structured representation of project data compatible with ohm's
 capabilities, facilitating the integration of Git repositories into ohm workflows while allowing for the gradual
...
from ohm.actions.extract_readme import ExtractReadMe
from ohm.actions.rebuild_class_view import RebuildClassView
from ohm.actions.rebuild_sequence_view import RebuildSequenceView
from ohm.const import GRAPH_REPO_FILE_REPO
from ohm.logs import logger
from ohm.schema import Message
from ohm.tools.libs.git import git_clone
...
from ohm.utils.di_graph_repository import DiGraphRepository
from ohm.utils.file_repository import FileRepository
from ohm.utils.git_repository import GitRepository
from ohm.utils.graph_repository import GraphKeyword, GraphRepository
...
class ImportRepo(Action):
    ...
    async def _create_system_design(self):
        ...
        content = await async_read(filename=sequence_files[0])
