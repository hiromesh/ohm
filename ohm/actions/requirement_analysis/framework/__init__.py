...
from ohm.actions.requirement_analysis.framework.evaluate_framework import EvaluateFramework
from ohm.actions.requirement_analysis.framework.write_framework import WriteFramework
from ohm.config2 import config
from ohm.utils.common import async_write
...
async def save_framework(
    ...
    if trd:
        ...
        await async_write(filename=pathname, data=trd)
    ...
    for i in items:
        ...
        await async_write(filename=pathname, data=v.content)
