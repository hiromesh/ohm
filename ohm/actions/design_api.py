...
from ohm.actions.design_api_an import (
...
from ohm.const import DATA_API_DESIGN_FILE_REPO, SEQ_FLOW_FILE_REPO
...
class WriteDesign(Action):
    ...
    async def _execute_api(
        ...
        if prd_filename:
            ...
            prd_content = await async_read(filename=prd_filename)
        ...
        async with DocsReporter(enable_llm_stream=True) as reporter:
            ...
            if not legacy_design_filename:
                ...
                old_design_content = await async_read(filename=legacy_design_filename)
            ...
            await async_write(filename=output_pathname, data=design.content)
