...
from ohm.repo_parser import DotClassInfo, RepoParser
from ohm.schema import UMLClassView
from ohm.utils.common import concat_namespace, split_namespace
...
class RebuildClassView(Action):
    ...
    def _diff_path(path_root: Path, package_root: Path) -> (str, str):
        ...
        Example:
            >>> _diff_path(path_root=Path("/Users/x/github/ohm"), package_root=Path("/Users/x/github/ohm/ohm"))
            "-", "ohm"

            >>> _diff_path(path_root=Path("/Users/x/github/ohm/ohm"), package_root=Path("/Users/x/github/ohm/ohm"))
            "=", "."
        """
    ...
    def _align_root(path: str, direction: str, diff_path: str) -> str:
        ...
        Example:
            >>> _align_root(path="ohm/software_company.py", direction="+", diff_path="ohm")
            "ohm/ohm/software_company.py"
