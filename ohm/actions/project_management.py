...
from ohm.actions.project_management_an import PM_NODE, REFINED_PM_NODE
from ohm.const import PACKAGE_REQUIREMENTS_FILENAME
...
from ohm.utils.report import DocsReporter
...
class WriteTasks(Action):
    ...
    async def _execute_api(
        ...
        if design_filename:
            ...
            content = await async_read(filename=design_filename)
        ...
        async with DocsReporter(enable_llm_stream=True) as reporter:
            ...
            await async_write(filename=output_pathname, data=file_content)
