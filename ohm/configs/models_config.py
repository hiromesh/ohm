...
Attributes:
    ...
    ohm_ROOT (Path): Root path for ohm files.
...
from ohm.config2 import merge_dict
from ohm.configs.llm_config import LLMConfig
from ohm.const import CONFIG_ROOT, ohm_ROOT
...
class ModelsConfig(YamlModel):
    ...
    Methods:
        ...
        from_home(cls, path): Loads configuration from ~/.ohm/config2.yaml.
    ...
    def from_home(cls, path):
        """
        Loads configuration from ~/.ohm/config2.yaml.
