...
from ohm.prompts.di.swe_agent import (
    CURRENT_BASH_STATE,
    MINIMAL_EXAMPLE,
    NEXT_STEP_TEMPLATE,
)
from ohm.roles.di.role_zero import RoleZero
from ohm.schema import Message
from ohm.tools.libs.git import git_create_pull
from ohm.tools.libs.terminal import Bash
...
class SWEAgent(RoleZero):
    ...
    async def _parse_commands_for_eval(self):
        ...
        if not self.rc.todo:
            from ohm.tools.swe_agent_commands.swe_agent_utils import extract_patch
