...
from ohm.actions.write_teaching_plan import TeachingPlanBlock, WriteTeachingPlanPart
from ohm.logs import logger
from ohm.roles import Role
from ohm.schema import Message
from ohm.utils.common import any_to_str, async_write
...
class Teacher(Role):
    ...
    async def save(self, content):
        ...
        await async_write(pathname, content)
