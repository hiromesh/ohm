...
# from ohm.actions.write_code_review import ValidateAndRewriteCode
from ohm.prompts.di.engineer2 import (
    CURRENT_STATE,
...
from ohm.schema import UserMessage
from ohm.strategy.experience_retriever import ENGINEER_EXAMPLE
from ohm.tools.libs.cr import CodeReview
from ohm.tools.libs.deployer import Deployer
from ohm.tools.libs.git import git_create_pull
from ohm.tools.libs.image_getter import ImageGetter
from ohm.tools.libs.terminal import Terminal
from ohm.tools.tool_registry import register_tool
from ohm.utils.common import CodeParser, async_write
from ohm.utils.report import EditorReporter
    ...
    async def write_new_code(self,
        ...
        async with EditorReporter(enable_llm_stream=True) as reporter:
            ...
            rsp = await self.llm.aask(context,
                                      system_msgs=[WRITE_CODE_SYSTEM_PROMPT])
            code = CodeParser.parse_code(text=rsp)
            await async_write(path, code)
